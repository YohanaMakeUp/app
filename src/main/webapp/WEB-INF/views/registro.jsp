	...
	<div class="content">
		<div id="fane1">
			...
			<input type="hidden" id="source" name="source" 
				...
				<label>Usuario </label><input id="nombreUsuario"
					name="nombreUsuario" type="text"><br> <label>Password
				</label><input id="password" name="password1" type="password"><br>
				<label>Repetir password </label><input id="password" name="password2" type="password"><br> 
